...
\begin{titlepage}
  \centering
  \vspace*{\fill}
  {\Huge\bfseries Acceso Remoto Seguro con WireGuard\par}
  \vspace{0.7cm}
  {\Large How-To: despliegue, pruebas de conexión y demostraciones\par}
  \vspace{1.3cm}
  {\large 72.20 Redes de Información\,---\,ITBA\,---\,1\textsuperscript{er} Cuatrimestre 2026\par}
  \vspace{2.4cm}
  {\large Jose Burgos (61525)\\[6pt] Pedro Curti (61616)\par}
  \vspace{1.6cm}
  {\large \today\par}
  \vspace*{\fill}
\end{titlepage}
